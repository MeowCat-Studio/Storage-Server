oS.Init({
    ...
    PicArr: function() {
        var a = oAbutilonHybriden.prototype,
        b = a.PicArr;
    ...
    LoadAccess: function(a) {
        ...
        NewEle("DivTeach", "div", 0, 0, EDAll); (function(d) {
            ...
            case 1:
                ...
                []);
                innerText(c, "而且，我已经翻到了金铃花和她的一些实验笔记");
                break;
            case 2:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
                ...
                []);
                innerText(c, "那就在家门前试试吧，我再找找有什么别的东西……");
                break;
            case 3:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
                ...
                []);
                innerText(c, "不过……我实验室的锥形瓶为什么会在僵尸博士的手下身上……");
                break;
            case 4:
                PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
                c.onclick = null;
